...
public class PlayerRanking {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!commands[0].equals("end")) {
            switch (commands[0]) {
                case "add":
                    handleCommandAdd(commands);
                    break;

                case "find":
                    handleCommandFind(commands);
                    break;

                case "ranklist":
                    handleCommandRanklist(commands);
                    break;
    ...
    private static void handleCommandRanklist(String[] commands) {
    ...
    private static void handleCommandFind(String[] commands) {
    ...
    private static void handleCommandAdd(String[] commands) {
